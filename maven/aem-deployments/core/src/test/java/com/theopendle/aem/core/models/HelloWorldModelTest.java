 ...
 */
package com.theopendle.aem.core.models;
...
import com.theopendle.aem.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "aem-deployments/components/helloworld");
